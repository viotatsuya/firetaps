...
import org.tf.GameActivity;
import org.tf.gl.GLHelpers;
import org.tf.gl.GLRect;
import org.tf.gl.sprite.Sprite;
import org.tf.gl.sprite.SpriteFont;
import org.tf.gl.sprite.SpriteFontBuilder;
import org.tf.gl.sprite.SpriteRegion;
...
import org.tf.util.CharString;
import org.tf.util.DataStreamHelpers;
import org.tf.util.MathHelpers;
import org.tf.R;
...
//		private int m_lastPickedKeyStrings;
	...
	private void createKeySprites(GL10 gl) {
		float tapzoneWidth=m_keysWidth/(
			...
			MIDDLE_KEY_FRACTION
		); // t / ( 3 + 2 * inbetweenkeyfractionofnormal)
		float middleTapzoneWidth=tapzoneWidth*MIDDLE_KEY_FRACTION;
